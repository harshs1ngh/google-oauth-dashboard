              ...
              {menuItems.map((menuItem) => (
                <li key={menuItem.id}>
                  <label
                    ...
                    className={`group relative cursor-pointer flex item-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark
